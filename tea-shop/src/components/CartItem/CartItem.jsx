        ...
        <>
            <div className={styles.container}>
                ...
                <div className={styles.countContainer}>
                    <button onClick={()=> changeQuantity(cart, "increase")} className={styles.countButton}>+</button>
                    <p>{cart.quantity>=1 ? cart.quantity: 1}</p>
                    <button onClick={()=>changeQuantity(cart, "decrease")} className={styles.countButton}>-</button>
                </div>
