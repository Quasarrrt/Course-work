...
const sortCards=(value)=>{
  ...
  return (
      <>
          <AppHeader/>
          <Routes>
              <Route path="/" element={<HomePage tea={tea} onCardClick={onCardClick}/>} exact="true"/>
              <Route path="/about" element={<AboutPage/>} exact="true"/>
              <Route path="/catalog" element={<CatalogPage tea={tea} onCardClick={onCardClick} sortCards={sortCards}/>} exact="true"/>
              <Route path="/contacts" element={<ContactsPage/>} exact="true"/>
              <Route path="/cart" element={<CartPage cart={cart} onCardDelete={onCardDelete}/>} exact="true"/>
          </Routes>
      </>
